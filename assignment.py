...
def time_series_plot(data, title, xlabel, ylabel):
    ...
    ----------
    data : DataFrame
        Containing the data for time series plot.
    title : String
        Title of the plot.
    xlabel : String
        xlabel for the plot.
...
def bar_plot(data, title, xlabel, ylabel):
    ...
    ----------
    data : DataFrame
        Containing the data for bar plot.
    title : String
        Title of the plot.
    xlabel : String
        xlabel for the plot.
...
def define_correlation():
    ...
    -------
    None.
    Reads the data from file paths and creates heatmap
    """
...
time_series_plot(population_country_columned, 
                 "Population growth percentage by year",
...
bar_plot(gdp_forest_country_columned, 
